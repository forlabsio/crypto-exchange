...
from app.services.bot_eviction import daily_drawdown_check, monthly_evaluation, daily_performance_update, renewal_check
...
async def lifespan(app: FastAPI):
    ...
    scheduler.add_job(renewal_check, "interval", hours=1)
    scheduler.start()
    yield
    scheduler.shutdown()
